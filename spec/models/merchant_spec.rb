...
RSpec.describe Merchant, type: :model do
  ...
  #     @item_3 = @merchant.items.create!(name: 'Marker', unit_price: 6,
  ...
  #     actual = @merchant.fave_customers.map do |customer|
  #       customer[:first_name]
  #     end
  #     expect(actual).to eq([@customer_4.first_name, @customer_1.first_name, @customer_2.first_name,
  #                           @customer_3.first_name, @customer_5.first_name])
  #   end
  #
  ...
  describe 'instance methods' do
    ...
    # it '#unshipped_items' do
    #   expect(@m1.unshipped_items).to eq([])
    # end
  end
end
